...
insert into action_news (news_id, category_zh, category_en, title_zh, title_en, summary_zh, summary_en, content_zh, content_en, thumb_url, publish_date, is_top, sort_num, status, del_flag, create_by, create_time, update_by, update_time, remark, link_url, is_external) values (3, 'ACTION 小组动态', 'ACTION team', '智能报告辅助工具进入内测', 'Intelligent reporting assistant enters closed beta', '五步向导：研究类型匹配、在线模板、内容校验、AI 辅助撰写、导出分享。', 'A five-step wizard: study-type matching, online templates, content validation, AI writing help and export/sharing.', NULL, NULL, '/assets/news-platform.png', '2026-06-01', '0', 2, '0', '0', 'migration', '2026-07-28 20:17:23', '', '2026-07-28 20:17:23', '原站精度为年月（2026-06），入库补为当月1日；原链接 assistant.html', '/assistant', '0');
