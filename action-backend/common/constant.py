...
class CommonConstant:
    ...
    SYSTEM_USER_TYPE: 后台系统用户的用户类型
    GUEST_USER_TYPE: 官网访客的用户类型
    """
    ...
    UNIQUE = True
    NOT_UNIQUE = False
    # sys_user.user_type：'00' 是后台系统用户，'01' 是官网访客。
    # 后台鉴权与后台用户列表只认 '00'，两套账号体系共用一张表但互不可见。
    SYSTEM_USER_TYPE = '00'
    GUEST_USER_TYPE = '01'
...
class ApiNamespace:
    ...
    ACTION_GUEST_EMAIL_CODE: 官网访客邮箱验证码接口命名空间
    ACTION_GUEST_REGISTER: 官网访客注册接口命名空间
    ...
    ACTION_GUEST_EMAIL_CODE = 'action:guest:email-code'
    ACTION_GUEST_REGISTER = 'action:guest:register'
